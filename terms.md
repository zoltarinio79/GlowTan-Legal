...
- The app cannot account for your individual medical history, medications, or conditions.
- You should always consult a qualified healthcare professional (such as a dermatologist) before making decisions about sun exposure, tanning, or sun protection — especially if you have a history of skin cancer, photosensitive conditions, fair skin, or take medications that increase UV sensitivity.
- Always follow established sun-safety practices: use broad-spectrum sunscreen, wear protective clothing, seek shade, and avoid prolonged or peak-hour exposure.

You use the app at your own risk. We are not responsible for any health outcomes resulting from your use of the app or your reliance on its guidance.
...
- You can manage and cancel subscriptions by going to **Settings → [Your Apple ID] → Subscriptions** on your iOS device.
...
We may change subscription pricing or features. If we do, you will be notified, and the change will not take effect until your next renewal period. You may cancel before the change takes effect.
...
- Interfere with the operation of the app or attempt to bypass its subscription or entitlement systems.
...
The app, including its design, code, graphics, and content (excluding your user content), is owned by us and protected by copyright and other laws. These Terms do not transfer ownership rights to you.

## 7. Disclaimer of Warranties

The app is provided **"as is"** and **"as available"** without warranties of any kind, whether express or implied, including warranties of merchantability, fitness for a particular purpose, accuracy, or non-infringement. We do not warrant that the app will be error-free, uninterrupted, or that UV/weather data will be accurate or timely.
...
We may suspend or terminate your access to the app if you breach these Terms. You may stop using the app at any time by uninstalling it. Termination does not entitle you to a refund except as required by law or Apple's policies.

## 10. Changes to These Terms

We may update these Terms from time to time. When we do, we will revise the "Last updated" date above. Material changes will be communicated within the app. Continued use after changes take effect means you accept the updated Terms.
...
You acknowledge that these Terms are between you and us, not with Apple. Apple is not responsible for the app or its content. In the event of a conflict between these Terms and the Apple Media Services Terms, the Apple Media Services Terms shall prevail with respect to your use through the App Store. Apple and its subsidiaries are third-party beneficiaries of these Terms and may enforce them against you.
